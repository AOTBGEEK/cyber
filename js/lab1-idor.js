...
const correctAnswers = {
    ...
    q2: 'c', // بتغيير المعرفات في عناوين URL والمعاملات
    q3: 'a', // التحقق من صلاحيات المستخدم لكل طلب
    q4: 'd', // لأنها غير قابلة للتنبؤ وصعبة التخمين
    q5: 'c'  // تسجيل المحاولة ومراقبة النشاط المشبوه
};
