...
const correctAnswers = {
    ...
    q2: 'a', // فحص URL وشهادة SSL والهوية البصرية
    q3: 'c', // تقنيات مصادقة وحماية البريد الإلكتروني
    q4: 'd', // تجاهل الرسالة والتحقق من المرسل مباشرة
    q5: 'a'  // المصادقة الثنائية والتعليم والوعي الأمني
};
