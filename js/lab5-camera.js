...
const correctAnswers = {
    ...
    q2: 'b', // مراقبة أيقونات الكاميرا في شريط العناوين وإعدادات المتصفح
    q3: 'b', // معايير للمصادقة القوية باستخدام الأجهزة الفيزيائية
    q4: 'b', // شرح واضح للاستخدام وعرض مؤشرات مرئية وإمكانية إلغاء
    q5: 'b'  // معالجتها محلياً عند الإمكان واستخدام تشفير قوي عند النقل
};
