...
const correctAnswers = {
    ...
    q2: 'b', // لأنه بيانات مصادقة حساسة ويمنع PCI DSS حفظها
    q3: 'b', // التحقق من HTTPS وشهادة SSL والنطاق الشرعي
    q4: 'b', // طبقة مصادقة إضافية وحماية من الاحتيال
    q5: 'b'  // مراقبة البيانات بانتظام واستخدام مواقع موثوقة مع HTTPS
};
