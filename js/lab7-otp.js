...
const correctAnswers = {
    ...
    q2: 'b', // هجمات تبديل SIM والهندسة الاجتماعية
    q3: 'b', // مشفرة بالهاش ومحفوظة في قاعدة بيانات آمنة
    q4: 'b', // رموز الأجهزة الفيزيائية (Hardware Tokens)
    q5: 'b'  // لتوفير طبقة أمان إضافية حتى لو تم اختراق كلمة المرور
};
